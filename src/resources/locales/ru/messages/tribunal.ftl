...
command-tribunal-timeout-active = В чате есть активный трибунал, перед началом нового подождите { $seconds }.
command-tribunal-timeout = Перед началом нового трибунала, подождите { $seconds }.
