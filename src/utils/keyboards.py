...
def captcha_keyboard(i18n: I18nContext, date: int, telegram_user_id: int, telegram_chat_id: int) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.button(
...
def configuration_main_keyboard(i18n: I18nContext, chat_info: ChatInfo) -> InlineKeyboardMarkup:
    ...
    # TODO: builder.button(text=i18n.keyboards.configuation.main.members(), callback_data='settings_members_btn')
...
def configuration_filter_keyboard(i18n: I18nContext, chat_info: ChatInfo) -> InlineKeyboardMarkup:
    ...
    builder.button(text=i18n.keyboards.configuration.filter.list(count=len(chat_info.filters_list)), callback_data='filters_list_btn')
